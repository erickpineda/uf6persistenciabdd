...
public class Asistente {
  ...
  /**
   * Genera un rango de soldado, sean: Capitán, Jefe de grupo o Marinero.
   * 
  ...
  public static String generaMatricula() {
	// La categoria es un número entero de 1 a 9
	int categoria = rand(1, 9);
	// La provincia son dos letras en Mayúscula
	String provinciaMaritima = generaCadenaAleatoria(2);
	// El distrito marítimo es un número entero de 0 a 9
	int distritoMaritimo = rand(0, 9);
	// El folio de inscripción es un número entero de 3 cifras y pueden ir ceros a la izquierda
	String folioInscripcion = String.format("%03d", generaNumeroConCantidadDeCifras(3));
	// El año de matriculación es un número entero de 2 cifras y pueden ir ceros a la izquierda
  ...
  public static String generaCadenaAleatoria(int longitud) {
	...
	for (int i = 0; i < longitud; i++) {
	  letra = (char) rand(65, 90); // Obtiene la letra en mayúscula
